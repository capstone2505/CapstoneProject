        ...
        <View>
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={styles.quantityContainer}>
              <TouchableOpacity style={styles.quantityButton} onPress={() => decreaseQuantity(0)}>
                <Text style={styles.quantityButtonText}>-</Text>
              </TouchableOpacity>
              <Text style={styles.quantity}>{quantities[0]}</Text>
              <TouchableOpacity style={styles.quantityButton} onPress={() => increaseQuantity(0)}>
                <Text style={styles.quantityButtonText}>+</Text>
              </TouchableOpacity>
            </View>
          </View>
      ...
      <View style={[styles.txt, { marginBottom: 5, flexDirection: 'row', backgroundColor: '#f5f5f5', width: 390, marginLeft: 10, marginRight: 20 }]}>
        ...
        <View>
          <View style={{ flexDirection: 'row' }}>
            <Text style={{ fontSize: 15, fontWeight: 'bold', textAlign: 'left', marginBottom: 5, padding: 2, borderRadius: 20, width: 150, paddingLeft: 10, marginTop: 3 }}>Package 1</Text>
            <View style={styles.quantityContainer}>
              <TouchableOpacity style={styles.quantityButton} onPress={() => decreaseQuantity(1)}>
                <Text style={styles.quantityButtonText}>-</Text>
              </TouchableOpacity>
              <Text style={styles.quantity}>{quantities[1]}</Text>
              <TouchableOpacity style={styles.quantityButton} onPress={() => increaseQuantity(1)}>
                <Text style={styles.quantityButtonText}>+</Text>
              </TouchableOpacity>
            </View>
          </View>
      ...
      <View style={[styles.txt, { marginBottom: 5, flexDirection: 'row', backgroundColor: '#f5f5f5', width: 390, marginLeft: 10, marginRight: 20 }]}>
        ...
        <View>
          <View style={{ flexDirection: 'row' }}>
            <Text style={{ fontSize: 15, fontWeight: 'bold', textAlign: 'left', marginBottom: 5, padding: 2, borderRadius: 20, width: 150, paddingLeft: 10, marginTop: 3 }}>Package 1</Text>
            <View style={styles.quantityContainer}>
              <TouchableOpacity style={styles.quantityButton} onPress={() => decreaseQuantity(2)}>
                <Text style={styles.quantityButtonText}>-</Text>
              </TouchableOpacity>
              <Text style={styles.quantity}>{quantities[2]}</Text>
              <TouchableOpacity style={styles.quantityButton} onPress={() => increaseQuantity(2)}>
                <Text style={styles.quantityButtonText}>+</Text>
              </TouchableOpacity>
            </View>
          </View>
