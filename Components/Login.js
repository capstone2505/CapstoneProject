...
export default function Login({ navigation }) {
  ...
  const handleError = () => {
    ...
    if (invaildMassage === 'auth/user-not-found') {
  ...
  return (
    <SafeAreaView style={{
      ...
      <View style={[styles.card, styles.shadowProp]}>
        <TextInput
          placeholder='Email'
          style={[styles.textInput, { borderColor: (email === '' && emailFocused === true) || emailFocused ? 'red' : 'white' }]}
          onChangeText={text => setEmail(text)}
        />
        <TextInput
          secureTextEntry
          placeholder='Password'
          style={[styles.textInput, { borderColor: (password === '' && passwordFocused === true) || passwordFocused ? 'red' : 'white' }]}
