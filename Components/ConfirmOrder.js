...
const ConfirmOrder = ({ navigation, route }) => {
  ...
  console.log("discountedTotal from Confirm", discountTotal);
  console.log("discountValue from Confirm", discountValue);
  console.log("subAmount from Confirm", subAmount);

  console.log("hi from order ", discountValue, discountTotal, subAmount);
  useEffect(() => {
    checkCardData();
  }, [userId]);
      ...
      </Text>
      {
        <>
          ...
          <View style={[styles.txt, { marginBottom: 10 }]}>
            <Text style={{ color: "black", margin: 2, fontSize: 20 }}>
              {" "}
              City: {dataC.city}{" "}
            </Text>
            <Text style={{ color: "black", margin: 2, fontSize: 20 }}>
              {" "}
              Building Number: {dataC.buildingNumber}{" "}
            </Text>
            <Text style={{ color: "black", margin: 2, fontSize: 20 }}>
              {" "}
              Street Name: {dataC.streetName}{" "}
            </Text>
            <Text style={{ color: "black", margin: 2, fontSize: 20 }}>
              {" "}
              street Number: {dataC.streetNumber}{" "}
            </Text>
          </View>
          ...
          <View style={[styles.txt, { marginBottom: 10 }]}>
            <Text style={{ color: "black", margin: 2, fontSize: 20 }}>
              {" "}
              Date: {dataC.datestring}{" "}
            </Text>
            <Text style={{ color: "black", margin: 2, fontSize: 20 }}>
              {" "}
              Time: {dataC.timestring}{" "}
            </Text>
          </View>
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <Pressable
            onPress={() =>
              navigation.navigate(
                checked === "first" ? "OrderedPlaced" : "PaymentDetails"
              )
            }
          >
