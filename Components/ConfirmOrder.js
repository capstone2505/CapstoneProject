    ...
    return (
      ...
      >
        <ScrollView>
          ...
          <Image
            style={{ width: 490, height: 200, alignItems: "center" }}
            source={require("../assets/Images/confirmOrder.png")}
          />
          {
                ...
                >
                  {item.cartItem.map((x, index) => {
                    ...
                    return (
                      <View
                        key={index}
                        style={{ flexDirection: "row", borderBottomWidth: 3 }}
                      >
                        ...
                        <View style={{ width: 160 }}>
                          <View style={{ flexDirection: "row" }}>
                            ...
                            <Text
                              style={{ color: "black", margin: 10, fontSize: 15 }}
                            >
                              {" "}
                              {x.price} QR{" "}
                            </Text>
          ...
          <View style={{ margin: 15 }}>
            ...
            <View>
              <Text style={{ color: "#998184", fontWeight: "bold" }}>
                {" "}
